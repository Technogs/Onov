...
public class FURenderer implements OnFUControlListener {
    ...
    public static void initFURenderer(Context context) {
        ...
        try {
          ...
          //  faceunity.fuLoadTongueModel(tongueDate);
            ...
            Log.e(TAG, "initFURenderer TAG error", e);
        }
    }
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "enter_facepup", 1);
                }
            }
        });
    }
    ...
    public void clearFaceShape() {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "clear_facepup", 1);
                }

                if (mItemsArray[ITEM_ARRAYS_AVATAR_HAIR] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_AVATAR_HAIR], "clear_facepup", 1);
                }
            }
        });
    }
    ...
    public void quitFaceup() {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "quit_facepup", 1);
                }
            }
        });
    }
    ...
    public void recomputeFaceup() {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "need_recompute_facepup", 1);
                }
            }
        });
    }
    ...
    public void fuItemSetParamFaceup(final String key, final double value) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "{\"name\":\"facepup\",\"param\":\"" + key + "\"}", value);
                }
            }
        });
    }
    ...
    public void fuItemSetParamFaceColor(final String key, final double[] value) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (value.length > 3) {
                    if (mItemsArray[ITEM_ARRAYS_AVATAR_HAIR] > 0) {
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_AVATAR_HAIR], key, value);
                    }
                } else {
                    if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], key, value);
                    }
                }
            }
        });
    ...
    public void setAvatarScale(final float scale) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "absoluteScale", scale);
                }
            }
        });
    }
    ...
    public void setAvatarHairScale(final float scale) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_AVATAR_HAIR] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_AVATAR_HAIR], "absoluteScale", scale);
                }
            }
        });
    }
    ...
    public void setAvatarTranslate(final double[] xyz) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "absoluteTranslate", xyz);
                }
            }
        });
    }
    ...
    public void setAvatarHairTranslate(final double[] xyz) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_AVATAR_HAIR] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_AVATAR_HAIR], "absoluteTranslate", xyz);
                }
            }
        });
    }
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX] > 0) {
                    if (isFront && mInputImageOrientation == 90) {
                        ...
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX], "is_swap_x", 1.0);
                    } else {
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX], "is_swap_x", 0.0);
                    }
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX], "is_front", isFront ? 1.0 : 0.0);
                }
            }
        });
    }
    ...
    private void prepareDrawFrame() {
        ...
        if (isNeedUpdateFaceBeauty && mItemsArray[ITEM_ARRAYS_FACE_BEAUTY_INDEX] > 0) {
            ...
            fuItemSetParam(itemFaceBeauty, BeautificationParam.FILTER_NAME, sFilterName);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.FILTER_LEVEL, mFilterLevel);

            fuItemSetParam(itemFaceBeauty, BeautificationParam.SKIN_DETECT, mSkinDetect);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.HEAVY_BLUR, 0.0f);
            fuItemSetParam(mItemsArray[ITEM_ARRAYS_FACE_BEAUTY_INDEX], BeautificationParam.BLUR_TYPE, mBlurType);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.BLUR_LEVEL, 6.0 * mBlurLevel);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.COLOR_LEVEL, mColorLevel);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.RED_LEVEL, mRedLevel);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.EYE_BRIGHT, mEyeBright);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.TOOTH_WHITEN, mToothWhiten);

            fuItemSetParam(itemFaceBeauty, BeautificationParam.FACE_SHAPE_LEVEL, mFaceShapeLevel);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.FACE_SHAPE, mFaceShape);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.EYE_ENLARGING, mEyeEnlarging);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.CHEEK_THINNING, mCheekThinning);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.CHEEK_NARROW, mCheekNarrow);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.CHEEK_SMALL, mCheekSmall);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.CHEEK_V, mCheekV);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.INTENSITY_NOSE, mIntensityNose);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.INTENSITY_CHIN, mIntensityChin);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.INTENSITY_FOREHEAD, mIntensityForehead);
            fuItemSetParam(itemFaceBeauty, BeautificationParam.INTENSITY_MOUTH, mIntensityMouth);
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    ...
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.ORIENTATION, orientation);
                }
            }
        });
    }
        ...
        if (mDefaultOrientation != rotation) {
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    int trackerOrientation = calculateFaceTrackerOrientation();
                    if (mItemsArray[ITEM_ARRAYS_EFFECT_INDEX] > 0) {
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "rotMode", mRotMode);
                        // 加载背景分割、全屏前景和全屏背景道具时，当手机发生旋转需要设置参数"rotationMode"
                        fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "rotationMode", trackerOrientation);
                    }
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_NEW_FACE_TRACKER] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_NEW_FACE_TRACKER], "orientation", orientation);
                }
            }
        });
    }
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX], "is_flip_points", isFlipPoints ? 1 : 0);
                }
            }
        });
    }
    ...
    public void onMusicFilterTime(final long time) {
        queueEvent(new Runnable() {
            @Override
            public void run() {
                fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "music_time", time);
            }
        });
    }
    ...
    public void onHairLevelSelected(@HairType final int type, int hairColorIndex, float hairColorLevel) {
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (type == HAIR_NORMAL) {
                    // 美发类型
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_HAIR_NORMAL_INDEX], "Index", mHairColorIndex);
                    // 美发强度
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_HAIR_NORMAL_INDEX], "Strength", mHairColorStrength);
                } else if (type == HAIR_GRADIENT) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_HAIR_GRADIENT_INDEX], "Index", mHairColorIndex);
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_HAIR_GRADIENT_INDEX], "Strength", mHairColorStrength);
                }
            }
        });
    }
    ...
    public void onPosterTemplateSelected(final int tempWidth, final int tempHeight, final byte[] temp, final float[] landmark) {
        ...
        // 模板图片的宽
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "template_width", tempWidth);
        // 模板图片的高
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "template_height", tempHeight);
        // 图片的特征点，75个点
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "template_face_points", posterTemplateLandmark);
        // 模板图片的 RGBA byte数组
    ...
    public void onPosterInputPhoto(final int inputWidth, final int inputHeight, final byte[] input, final float[] landmark) {
        ...
        // 输入图片的宽
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "input_width", inputWidth);
        // 输入图片的高
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "input_height", inputHeight);
        // 输入图片的特征点，75个点
        fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "input_face_points", posterPhotoLandmark);
        // 输入图片的 RGBA byte 数组
...
//                                    Log.v(TAG, "clear: setParams double:" + key + ", 0.0");
    ...
    public void setMakeupItemIntensity(final String name, final double density) {
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX], name, density);
                } else {
                    selectMakeupItem(new HashMap<>(mMakeupParams), false);
                }
            }
    ...
    public void setMakeupItemColor(final String name, final double[] colors) {
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_FACE_MAKEUP_INDEX], name, colors);
                } else {
                    selectMakeupItem(new HashMap<>(mMakeupParams), false);
                }
            }
    ...
    public void setBodySlimIntensity(final float intensity) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.BODY_SLIM_STRENGTH, intensity);
                }
            }
        });
    }
    ...
    public void setLegSlimIntensity(final float intensity) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.LEG_SLIM_STRENGTH, intensity);
                }
            }
        });
    }
    ...
    public void setWaistSlimIntensity(final float intensity) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.WAIST_SLIM_STRENGTH, intensity);
                }
            }
        });
    }
    ...
    public void setShoulderSlimIntensity(final float intensity) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.SHOULDER_SLIM_STRENGTH, intensity);
                }
            }
        });
    }
    ...
    public void setHipSlimIntensity(final float intensity) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                if (mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_BEAUTIFY_BODY], BeautifyBodyParam.HIP_SLIM_STRENGTH, intensity);
                }
            }
        });
    }
    ...
    public void onLightMakeupBatchSelected(List<MakeupItem> makeupItems) {
        ...
        for (final Integer integer : keySet) {
            queueEvent(new Runnable() {
                @Override
                public void run() {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIGHT_MAKEUP_INDEX], MakeupParamHelper.getMakeupIntensityKeyByType(integer), 0);
                }
            });
        }
        ...
        if (makeupItems != null && makeupItems.size() > 0) {
            ...
            queueEvent(new Runnable() {
                @Override
                public void run() {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIGHT_MAKEUP_INDEX], "is_makeup_on", 0);
                }
            });
        }
    }
    ...
    public void onLightMakeupOverallLevelChanged(final float level) {
        ...
        for (final Map.Entry<Integer, MakeupItem> entry : entries) {
            queueEvent(new Runnable() {
                @Override
                public void run() {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIGHT_MAKEUP_INDEX], MakeupParamHelper.getMakeupIntensityKeyByType(entry.getKey()), level);
    ...
    public void setIsCartoon(final boolean isCartoon) {
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX], "is_use_cartoon", isCartoon ? 1 : 0);
                }
            }
        });
    }
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                if (mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX] > 0) {
                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_CHANGE_FACE_INDEX], "warp_intensity", value);
                }
            }
        });
    }
    ...
    private void updateEffectItemParams(Effect effect, final int itemHandle) {
        ...
        if (mIsInputImage == 1) {
            fuItemSetParam(itemHandle, "isAndroid", 0.0);
        } else {
            fuItemSetParam(itemHandle, "isAndroid", 1.0);
        }
        int effectType = effect.effectType();
        if (effectType == Effect.EFFECT_TYPE_NORMAL) {
            //rotationAngle 参数是用于旋转普通道具
            fuItemSetParam(itemHandle, "rotationAngle", 360 - mInputPropOrientation);
        }
        ...
        if (effectType == Effect.EFFECT_TYPE_AVATAR) {
            // Avatar 头型和头发镜像
            fuItemSetParam(itemHandle, "isFlipExpr", back);
        ...
        if (effectType == Effect.EFFECT_TYPE_ANIMOJI || effectType == Effect.EFFECT_TYPE_PORTRAIT_DRIVE) {
            // 镜像顶点
            fuItemSetParam(itemHandle, "is3DFlipH", back);
            // 镜像表情
            fuItemSetParam(itemHandle, "isFlipExpr", back);
            //这两句代码用于识别人脸默认方向的修改，主要针对animoji道具的切换摄像头倒置问题
            fuItemSetParam(itemHandle, "camera_change", 1.0);
            faceunity.fuSetDefaultRotationMode((360 - mInputImageOrientation) / 90);
        }
        ...
        if (effectType == Effect.EFFECT_TYPE_GESTURE) {
            ...
            fuItemSetParam(itemHandle, "is3DFlipH", back);
            fuItemSetParam(itemHandle, "loc_y_flip", back);
            fuItemSetParam(itemHandle, "loc_x_flip", back);
            fuItemSetParam(itemHandle, "rotMode", mRotMode);
            int trackerOrientation = calculateFaceTrackerOrientation();
            fuItemSetParam(mItemsArray[ITEM_ARRAYS_EFFECT_INDEX], "rotationMode", trackerOrientation);
        }
        ...
        if (effectType == Effect.EFFECT_TYPE_ANIMOJI) {
            // 镜像跟踪（位移和旋转）
            fuItemSetParam(itemHandle, "isFlipTrack", back);
            // 镜像灯光
            fuItemSetParam(itemHandle, "isFlipLight ", back);
            // 设置 Animoji 跟随人脸
            fuItemSetParam(itemHandle, "{\"thing\":\"<global>\",\"param\":\"follow\"}", 1);
        }
    ...
    private void setAvatarHairParams(int itemAvatarHair) {
        if (itemAvatarHair > 0) {
            int back = mCurrentCameraType == Camera.CameraInfo.CAMERA_FACING_BACK ? 1 : 0;
            fuItemSetParam(itemAvatarHair, "is3DFlipH", back);
            fuItemSetParam(itemAvatarHair, "isFlipTrack", back);
        }
    }
                    ...
                    if (!TextUtils.isEmpty(path)) {
                        ...
                        queueEvent(new Runnable() {
                            ...
                            public void run() {
                                ...
                                fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.IS_MAKEUP_ON, 1.0);
                                fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.MAKEUP_INTENSITY, 1.0);
                                fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.REVERSE_ALPHA, 1.0);
                                if (mLipStickColor != null) {
                                    if (makeupItem.getType() == FaceMakeup.FACE_MAKEUP_TYPE_LIPSTICK) {
                                        fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.MAKEUP_LIP_COLOR, mLipStickColor);
                                        fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.MAKEUP_LIP_MASK, 1.0);
                                    }
                                } else {
                                    fuItemSetParam(itemHandle, MakeupParamHelper.MakeupParam.MAKEUP_INTENSITY_LIP, 0.0);
                                }
                                ...
                                fuItemSetParam(itemHandle, MakeupParamHelper.getMakeupIntensityKeyByType(makeupItem.getType()), makeupItem.getLevel());
                            }
                        });
                    } else {
                        // 卸某个妆
                        queueEvent(new Runnable() {
                            ...
                            public void run() {
                                if (mItemsArray[ITEM_ARRAYS_LIGHT_MAKEUP_INDEX] > 0) {
                                    fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIGHT_MAKEUP_INDEX],
...
//                                    Log.v(TAG, "run: setParams double array:" + key + ", value:" + Arrays.toString(val));
                                    fuItemSetParam(itemHandle, key, val);
                                } else if (value instanceof Double) {
                                    Double val = (Double) value;
                ...
                case ITEM_ARRAYS_HAIR_NORMAL_INDEX: {
                    ...
                    queueEvent(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // 美发类型
                            fuItemSetParam(itemHair, "Index", mHairColorIndex);
                            // 美发强度
                            fuItemSetParam(itemHair, "Strength", mHairColorStrength);
                ...
                case ITEM_ARRAYS_CARTOON_FILTER_INDEX: {
                    ...
                    if (style >= 0) {
                        ...
                        queueEvent(new Runnable() {
                            @Override
                            public void run() {
                                fuItemSetParam(mItemsArray[ITEM_ARRAYS_CARTOON_FILTER_INDEX], "style", style);
                                GlUtil.logVersionInfo();
                                int glMajorVersion = GlUtil.getGlMajorVersion();
                                fuItemSetParam(mItemsArray[ITEM_ARRAYS_CARTOON_FILTER_INDEX], "glVer", glMajorVersion);
                            }
                        });
                    } else {
                        queueEvent(new Runnable() {
                    ...
                    if (textureImage != null) {
                        queueEvent(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // 设置五官类型
                                fuItemSetParam(itemHandle, "group_type", livePhoto.getGroupType());
                                // 设置五官点位
                                fuItemSetParam(itemHandle, "group_points", livePhoto.getGroupPoints());
                                // 输入图片的宽
                                fuItemSetParam(itemHandle, "target_width", textureImage.getWidth());
                                // 输入图片的高
                                fuItemSetParam(itemHandle, "target_height", textureImage.getHeight());
                                // 输入图片的 RGBA byte 数组
                                faceunity.fuCreateTexForItem(itemHandle, "tex_input", textureImage.getBytes(), textureImage.getWidth(), textureImage.getHeight());
                                // 设置插值开关
                                fuItemSetParam(mItemsArray[ITEM_ARRAYS_LIVE_PHOTO_INDEX], "use_interpolate2", 0.0);
                                // 设置使用卡通点位运行
                                setIsCartoon(true);
                            }
                        });
                ...
                case ITEM_ARRAYS_BEAUTIFY_BODY: {
                    ...
                    queueEvent(new Runnable() {
                        ...
                        public void run() {
                            ...
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.BODY_SLIM_STRENGTH, mBodySlimStrength);
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.LEG_SLIM_STRENGTH, mLegSlimStrength);
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.WAIST_SLIM_STRENGTH, mWaistSlimStrength);
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.SHOULDER_SLIM_STRENGTH, mShoulderSlimStrength);
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.HIP_SLIM_STRENGTH, mHipSlimStrength);
                            int orientation;
                            if (mIsInputImage == 1) {
                                orientation = 0;
                            } else {
                            ...
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.DEBUG, 0.0);
                            fuItemSetParam(itemBeautifyBody, BeautifyBodyParam.ORIENTATION, orientation);
