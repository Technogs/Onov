...
import com.application.onovapplication.debate.vlive.protocol.interfaces.GeneralService;
import com.application.onovapplication.debate.vlive.protocol.interfaces.PKService;
import com.application.onovapplication.debate.vlive.protocol.interfaces.ProductService;
import com.application.onovapplication.debate.vlive.protocol.interfaces.RoomService;
import com.application.onovapplication.debate.vlive.protocol.interfaces.SeatService;
import com.application.onovapplication.debate.vlive.protocol.interfaces.UserService;
import com.application.onovapplication.debate.vlive.protocol.model.body.CreateRoomRequestBody;
import com.application.onovapplication.debate.vlive.protocol.model.body.CreateUserBody;
import com.application.onovapplication.debate.vlive.protocol.model.body.LoginBody;
import com.application.onovapplication.debate.vlive.protocol.model.body.ModifyUserStateRequestBody;
...
import com.application.onovapplication.debate.vlive.protocol.model.body.UserRequestBody;
...
class Client {
    ...
    void requestVersion(long reqId, String appCode, int osType, int terminalType, String appVersion) {
        Log.e("GetCode ","config "+reqId);
        Log.e("GetCode ","osType "+osType);
        Log.e("GetCode ","msg"+ terminalType);
        Log.e("GetCode ","msg"+ appVersion);
        Log.e("GetCode ","msg"+ appVersion);
        mGeneralService.requestAppVersion(reqId, Request.APP_VERSION,
                appCode, osType, terminalType, "3.2.1").enqueue(new Callback<AppVersionResponse>() {
            @Override
            @EverythingIsNonNull
            public void onResponse(Call<AppVersionResponse> call, Response<AppVersionResponse> response) {
                ...
                Log.e("GetCode ","config "+response.body().data.config);
                Log.e("GetCode ","data "+response.body().data);
                Log.e("GetCode ","error body"+response.body().code);
