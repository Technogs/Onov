...
import com.application.onovapplication.debate.vlive.ui.profile.AboutActivity;
import com.application.onovapplication.debate.vlive.ui.profile.ModifyUserNameActivity;
...
public class MeFragment extends AbstractFragment implements View.OnClickListener {
   ...
   PreferenceManager userPreferences;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AppCompatImageView   mimage = mLayout.findViewById(R.id.user_profile_icon);
        userPreferences= new PreferenceManager(requireActivity());
        mNameText.setText(userPreferences.getuserDetails().getFullName());
//        mNameText.setText(profile.getUserName());
        Glide.with(requireActivity()).load(userPreferences.getuserDetails().getProfilePic()).into(mimage);

        mProfileTitleNameText = mLayout.findViewById(R.id.user_profile_nickname);
        mProfileTitleNameText.setText(userPreferences.getuserDetails().getFullName());
