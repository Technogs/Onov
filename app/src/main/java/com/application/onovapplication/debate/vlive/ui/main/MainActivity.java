package com.application.onovapplication.debate.vlive.ui.main;
...
import com.application.onovapplication.debate.vlive.ui.components.PrivacyTermsDialog;
import com.application.onovapplication.debate.vlive.utils.Global;
import com.application.onovapplication.debate.vlive.utils.RandomUtil;
...
public class MainActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //initPrivacy();
        userPreferences= new PreferenceManager(this);
...
//            getMusicList();
    ...
    public void onAppVersionResponse(AppVersionResponse response) {
        ...
        Log.e("Response","res "+response.data);
        Log.e("Response","res TT"+response.data.appCode);
        Log.e("Response","res TT"+response.data.config.appId);
...
//        config().setAppId(getString(R.string.bugly_app_id));
//        application().initEngine(getString(R.string.bugly_app_id));
        mAppIdTryCount = 0;
        login();
    }
