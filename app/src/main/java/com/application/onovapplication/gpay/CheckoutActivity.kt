...
import com.application.onovapplication.gpay.PaymentsUtil
...
import com.application.onovapplication.databinding.ActivityCheckoutBinding
...
binding.amount.setText(amount)
        ...
        binding.googlePayButton.buttonGpay.setOnClickListener { requestPayment() }
    }
    ...
    private fun setGooglePayAvailable(available: Boolean) {
        if (available) {
            binding.googlePayButton.buttonGpay.visibility = View.VISIBLE
        } else {
            Toast.makeText(
                this,
    ...
    private fun requestPayment() {
        ...
        binding.googlePayButton.buttonGpay.isClickable = false

        // The price provided to the API should include taxes and shipping.
        // This price is not displayed to the user.
        val garmentPriceMicros = ( (amount).toDouble() * 1000000).roundToLong()
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when (requestCode) {
            ...
            LOAD_PAYMENT_DATA_REQUEST_CODE -> {
                ...
                binding.googlePayButton.buttonGpay.isClickable = true
            }
        }
    }
    ...
    private fun handlePaymentSuccess(paymentData: PaymentData) {
        ...
        try {
            ...
            if (paymentMethodData
                ...
                Log.d("token", paymentMethodData.getString("token"))
            ...
            Log.d("GooglePaymentTokens  ***2**", paymentMethodData
                .getString("token"))
