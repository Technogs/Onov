...
package com.application.onovapplication.gpay

import android.app.Activity
import com.application.onovapplication.gpay.ConstantsGpay
...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(ConstantsGpay.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (ConstantsGpay.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
            (ConstantsGpay.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
                    ConstantsGpay.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty())) {
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(ConstantsGpay.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(ConstantsGpay.SUPPORTED_NETWORKS)
     ...
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(ConstantsGpay.SUPPORTED_METHODS)
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", ConstantsGpay.COUNTRY_CODE)
            put("currencyCode", ConstantsGpay.CURRENCY_CODE)
        }
    }
        ...
        try {
            return JSONObject(baseRequest.toString()).apply {
                ...
                val shippingAddressParameters = JSONObject().apply {
                    ...
                    put("allowedCountryCodes", JSONArray(ConstantsGpay.SHIPPING_SUPPORTED_COUNTRIES))
                }
